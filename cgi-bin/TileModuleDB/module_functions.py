...
def add_test_tab(barcode, board_id):
    ...
    try:
        ...
        cur.execute('select name from Board_type where type_sn="%s"' % barcode[3:9])
        board_name = cur.fetchall()[0][0]
        print('<div class="row">')
        print('<div class="col-md-3 pt-4 ps-5 mx-2 my-2">')
        print('<h4>')
        print('Major Type: %s' % barcode[3:5])
        print('</h4>')
        print('</div>')
        print('<div class="col-md-3 pt-4 ps-5 mx-2 my-2">')
        print('<h4>')
        print('Sub Type: %s' % board_name)
        print('</h4>')
        print('</div>')
        print('<div class="col-md-3 pt-4 ps-5 mx-2 my-2">')
        print('<h4>')
        print('Serial Number: %s' % barcode[10:])
        print('</h4>')
        print('</div>')
        print('</div>')
